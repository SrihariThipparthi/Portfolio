...
function About() {
  return (
    <motion.div
      ...
      className="flex flex-col items-center justify-center min-h-screen p-4 gradient-adaptive"
    >
      <motion.h2
        initial={{ x: -100, opacity: 0 }}
        whileInView={{ x: 0, opacity: 1 }}
        transition={{ duration: 0.8 }}
        className="text-4xl font-bold text-blue-500 dark:text-blue-400 mb-8"
      >
        About Me
      </motion.h2>
      <motion.div
        ...
        transition={{ duration: 0.8 }}
        className="max-w-2xl text-adaptive-secondary text-center space-y-4"
      >
